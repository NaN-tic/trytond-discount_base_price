...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-discount_base_price',
    download_url='https://github.com:nantic/trytond-discount_base_price.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-discount_base_price.git'
    },
    classifiers=[
